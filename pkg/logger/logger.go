...
func InitLogger(filename string, maxSize, maxBackup, maxAge int, compress bool, logType string, level string) {
	...
	Logger = zap.New(core,
		...
		// 	String: helpers.GenerateTraceID(),
		// }),
	)
...
func Debug(moduleName string, fields ...zap.Field) {
	fields = append(fields, zap.String("trace-id", traceid.TraceID))
...
func DebugString(moduleName, name, msg string) {
	Logger.Debug(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, msg))
}

func InfoString(moduleName, name, msg string) {
	Logger.Info(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, msg))
}

func WarnString(moduleName, name, msg string) {
	Logger.Warn(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, msg))
}

func ErrorString(moduleName, name, msg string) {
	Logger.Error(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, msg))
}

func FatalString(moduleName, name, msg string) {
	Logger.Fatal(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, msg))
}

// DebugJSON 记录一条字符串类型的 debug 日志，调用示例：
//         logger.DebugString("SMS", "短信内容", string(result.RawResponse))
func DebugJSON(moduleName, name string, value interface{}) {
	Logger.Debug(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, jsonString(value)))
}

func InfoJSON(moduleName, name string, value interface{}) {
	Logger.Info(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, jsonString(value)))
}

func WarnJSON(moduleName, name string, value interface{}) {
	Logger.Warn(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, jsonString(value)))
}

func ErrorJSON(moduleName, name string, value interface{}) {
	Logger.Error(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, jsonString(value)))
}

func FatalJSON(moduleName, name string, value interface{}) {
	Logger.Fatal(moduleName, zap.String("trace-id", traceid.TraceID), zap.String(name, jsonString(value)))
}
